...
class PhasedSparkAuthorizerTest {
    ...
    void shouldFailOpenWhenGovernanceThrows() {
        ...
        PhasedSparkAuthorizer authorizer = new PhasedSparkAuthorizer(governanceClient, request -> rangerCalls[0]++, true);
    ...
    void shouldThrowWhenBlockAction() {
        ...
        PhasedSparkAuthorizer authorizer = new PhasedSparkAuthorizer(governanceClient, request -> {
        }, true);
    ...
    void shouldRethrowAndCallbackWhenStrictCheckFailure() {
        ...
        PhasedSparkAuthorizer authorizer = new PhasedSparkAuthorizer(
                governanceClient,
                request -> {
