...
@Component
public class SlackMsgNotifier implements ChannelMsgNotifier {
    private final NotificationProperties properties;
    private final WebhookSender sender;

    public SlackMsgNotifier(NotificationProperties properties, WebhookSender sender) {
    ...
    public void send(String receiver, String title, String content) {
        ...
        sender.postJson(properties.getSlack().getWebhookUrl(), payload);
    }
